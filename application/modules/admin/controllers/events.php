...
class Events extends AdminController {
    ...
    function index($page="")
    {
		...
		$query  = $this->db->get_where('news_event', array('category' => 'events'));

		$config['uri_segment'] = 4;
		$config['base_url'] = $this->config->item('base_url').'/admin/events/index/';
        ...
        $this->smarty->assign('list', $rows);
        $this->smarty->display('events/list.html');
    ...
    function do_adding()
    {
		...
		redirect('admin/events/index/'.$this->input->post('page_num'), 'refresh');
    ...
    function viewing($news_event_id="", $page_num="")
    {
		...
		$this->smarty->assign('page_num', $page_num);
        $this->smarty->display('events/view.html');
    ...
    function deleting($news_event_id="", $page_num="")
    {
		...
		redirect('admin/events/index/'.$page_num, 'refresh');
