<?php /* Smarty version 2.6.19, created on 2009-05-21 05:47:17
         compiled from download_center/list.html */ ?>
...
download_center/adding/<?php echo $this->_tpl_vars['page_num']; ?>
...
?>
				<tr>
					<td width="60"><input type="checkbox" class="check" name="ar_<?php echo $this->_tpl_vars['item']['upload_id']; ?>
" value="<?php echo $this->_tpl_vars['item']['upload_id']; ?>
"></td>
...
download_center/viewing/<?php echo $this->_tpl_vars['item']['upload_id']; ?>
/<?php echo $this->_tpl_vars['page_num']; ?>
"><img src="<?php echo $this->_tpl_vars['IMG_PATH']; ?>
view.gif"></a></td>
					<td width="30"><a href="<?php echo $this->_tpl_vars['ADMIN_PATH']; ?>
download_center/editing/<?php echo $this->_tpl_vars['item']['upload_id']; ?>
/<?php echo $this->_tpl_vars['page_num']; ?>
"><img src="<?php echo $this->_tpl_vars['IMG_PATH']; ?>
edit.gif"></td>
					<td width="30"><input type="checkbox" class="active"  id="<?php echo $this->_tpl_vars['item']['upload_id']; ?>
" name="act_<?php echo $this->_tpl_vars['item']['upload_id']; ?>
" onClick="javascript:active_check('../../../services/uploads', '<?php echo $this->_tpl_vars['item']['upload_id']; ?>
')" value="<?php echo $this->_tpl_vars['item']['upload_id']; ?>
...
download_center/deleting/<?php echo $this->_tpl_vars['item']['upload_id']; ?>
/<?php echo $this->_tpl_vars['page_num']; ?>
')"><img src="<?php echo $this->_tpl_vars['IMG_PATH']; ?>
delete.gif"></td>
				</tr>
...
download_center/multi_deleting" onsubmit="return delete_all_check()">
