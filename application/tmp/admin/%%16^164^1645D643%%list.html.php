<?php /* Smarty version 2.6.19, created on 2009-05-21 13:13:57
         compiled from database_alumni/list.html */ ?>
...
database_alumni/adding/index/<?php echo $this->_tpl_vars['page_num']; ?>
...
?>
				<tr>
					<td width="60"><input type="checkbox" class="check" name="ar_<?php echo $this->_tpl_vars['item']['unique_id']; ?>
" value="<?php echo $this->_tpl_vars['item']['unique_id']; ?>
"></td>
					<td><span class="BoldTxt"><?php echo $this->_tpl_vars['item']['name']; ?>
</span></td>
					<td width="30"><a href="<?php echo $this->_tpl_vars['ADMIN_PATH']; ?>
database_alumni/viewing/<?php echo $this->_tpl_vars['item']['unique_id']; ?>
/<?php echo $this->_tpl_vars['page_num']; ?>
"><img src="<?php echo $this->_tpl_vars['IMG_PATH']; ?>
view.gif"></a></td>
					<td width="30"><a href="<?php echo $this->_tpl_vars['ADMIN_PATH']; ?>
database_alumni/editing/<?php echo $this->_tpl_vars['item']['unique_id']; ?>
/<?php echo $this->_tpl_vars['page_num']; ?>
"><img src="<?php echo $this->_tpl_vars['IMG_PATH']; ?>
edit.gif"></td>
					<td width="30"><a href="javascript:void();" onClick="javascript:delete_confirm('<?php echo $this->_tpl_vars['ADMIN_PATH']; ?>
database_alumni/deleting/<?php echo $this->_tpl_vars['item']['unique_id']; ?>
/<?php echo $this->_tpl_vars['page_num']; ?>
')"><img src="<?php echo $this->_tpl_vars['IMG_PATH']; ?>
delete.gif"></td>
				</tr>
...
database_alumni/multi_deleting" onsubmit="return delete_all_check()">
