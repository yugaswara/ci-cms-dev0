<?php /* Smarty version 2.6.19, created on 2009-05-21 23:21:12
         compiled from events/list.html */ ?>
...
events/adding/<?php echo $this->_tpl_vars['page_num']; ?>
...
events/viewing/<?php echo $this->_tpl_vars['item']['news_event_id']; ?>
/<?php echo $this->_tpl_vars['page_num']; ?>
"><img src="<?php echo $this->_tpl_vars['IMG_PATH']; ?>
view.gif"></a></td>
					<td width="30"><a href="<?php echo $this->_tpl_vars['ADMIN_PATH']; ?>
events/editing/<?php echo $this->_tpl_vars['item']['news_event_id']; ?>
/<?php echo $this->_tpl_vars['page_num']; ?>
"><img src="<?php echo $this->_tpl_vars['IMG_PATH']; ?>
edit.gif"></td>
					<td width="30"><input type="checkbox" class="active" id="<?php echo $this->_tpl_vars['item']['news_event_id']; ?>
" onClick="javascript:active_check('../../../services/events', '<?php echo $this->_tpl_vars['item']['news_event_id']; ?>
...
events/deleting/<?php echo $this->_tpl_vars['item']['news_event_id']; ?>
/<?php echo $this->_tpl_vars['page_num']; ?>
')"><img src="<?php echo $this->_tpl_vars['IMG_PATH']; ?>
delete.gif"></td>
				</tr>
...
events/multi_deleting" onsubmit="return delete_all_check()">
