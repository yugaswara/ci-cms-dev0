<?php /* Smarty version 2.6.19, created on 2009-05-21 23:21:37
...
news/index/<?php echo $this->_tpl_vars['page_num']; ?>
...
news/<?php echo $this->_tpl_vars['target']; ?>
">
<table width="100%" border="0">
	<tr>
		<td></td><td></td><td><input type="hidden" name="category" value="news"></td>
	<tr>
	<tr>
		<td>Date</td><td>:</td>
		<td>
...
" style="width:250px"></td>
	...
	<tr><td>Content</td><td>:</td>
		<td><textarea name="id_content" id="id_content" rows="20" cols="70"><?php echo $this->_tpl_vars['list']['id_content']; ?>
</textarea>
	</td></tr>
	</table>
...
" style="width:250px"></td>
	...
	<tr><td>Content</td><td>:</td>
		<td><textarea name="en_content" id="en_content" rows="20" cols="70"><?php echo $this->_tpl_vars['list']['en_content']; ?>
</textarea>
	</td></tr>
	</table>
	</div>
...
">
				...
				<input class="BlueButton Left" type="submit" name="save" value="Save">
				</div>
				</form>
		</div>
	<?php $_smarty_tpl_vars = $this->_tpl_vars;
