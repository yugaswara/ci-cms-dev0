<?php /* Smarty version 2.6.19, created on 2009-05-26 05:36:51
         compiled from links/list.html */ ?>
...
links/adding/index/<?php echo $this->_tpl_vars['page_num']; ?>
...
?>
				<tr>
					<td width="60"><input type="checkbox" class="check" name="ar_<?php echo $this->_tpl_vars['item']['links_id']; ?>
" value="<?php echo $this->_tpl_vars['item']['links_id']; ?>
"></td>
					<td><span class="BoldTxt"><?php echo $this->_tpl_vars['item']['link_name']; ?>
</span></td>
					<td width="30"><a href="<?php echo $this->_tpl_vars['ADMIN_PATH']; ?>
links/viewing/<?php echo $this->_tpl_vars['item']['links_id']; ?>
/<?php echo $this->_tpl_vars['page_num']; ?>
"><img src="<?php echo $this->_tpl_vars['IMG_PATH']; ?>
view.gif"></a></td>
					<td width="30"><a href="<?php echo $this->_tpl_vars['ADMIN_PATH']; ?>
links/editing/<?php echo $this->_tpl_vars['item']['links_id']; ?>
/<?php echo $this->_tpl_vars['page_num']; ?>
"><img src="<?php echo $this->_tpl_vars['IMG_PATH']; ?>
edit.gif"></td>
					<td width="30"><a href="javascript:void();" onClick="javascript:delete_confirm('<?php echo $this->_tpl_vars['ADMIN_PATH']; ?>
links/deleting/<?php echo $this->_tpl_vars['item']['links_id']; ?>
/<?php echo $this->_tpl_vars['page_num']; ?>
')"><img src="<?php echo $this->_tpl_vars['IMG_PATH']; ?>
delete.gif"></td>
				</tr>
...
links/multi_deleting" onsubmit="return delete_all_check()">
